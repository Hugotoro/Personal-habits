...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference("Dashboard.count") do
      post dashboards_url, params: { dashboard: { date_goal: @dashboard.date_goal, description: @dashboard.description, title: @dashboard.title } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { date_goal: @dashboard.date_goal, description: @dashboard.description, title: @dashboard.title } }
